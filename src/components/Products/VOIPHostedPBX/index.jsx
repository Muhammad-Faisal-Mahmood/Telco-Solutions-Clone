...
function index() {
  const SpecificHeroSection = (
    <HeroSection
      bgImage={
        "https://assets.website-files.com/5b68628a23db9d1747f9f227/5b99a27089aab7bce3d59d3f__voip-min.jpg"
      }
      logoImage={
        "https://assets.website-files.com/5b68628a23db9d1747f9f227/5b75d9fd34de1d03ac9bd194_icns_voup.svg"
      }
      heading={"Hosted VOIP PBX Phone Service"}
      paragraph={
  ...
  const SpecificJSX = (
    <div>
      ...
      <div className="p-8">
        ...
        />
        <h1 className="text-3xl  mb-4">1&#41; Save Money on Upkeep</h1>
        <Paragraph
          text={
        ...
        <h1 className="text-3xl  mb-4">2&#41; Support a Large Workforce</h1>
        <Paragraph
          text={
        ...
        <ul className="list-disc pl-8 pb-8">
          <li className="italic font-semibold py-1 text-gray-800">
        ...
        <Paragraph
          text={
            "Want to adopt an easy-to-use and maintain VoIP hosted PBX solution? Contact TelcoSolutions and request a quote today!"
          }
        />
      </div>
    </div>
